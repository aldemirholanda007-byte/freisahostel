...
Um espaço simples, funcional e acolhedor, perfeito para quem busca conforto, praticidade e uma excelente localização.`,highlights:[{icon:`🚿`,title:`Banheiro compartilhado`,text:`Banheiro de uso coletivo, sempre limpo e organizado, disponível para todos os hóspedes.`},{icon:`🛋️`,title:`Áreas compartilhadas`,text:`Espaços compartilhados, com área para circulação e convivência.`},{icon:`🛏️`,title:`Quarto compartilhado`,text:`Dormitórios coletivos, confortáveis e seguros, ideais para quem busca economia e convivência.`}],hasCarousel:!1},{name:`Suítes`,location:`Quarto em Rio de Janeiro, Brasil`,beds:3,bathrooms:`Banheiro privativo`,images:[`https://i.imgur.com/W9koWkI.jpeg`],description:`Simplicidade, conforto e ótima localização definem esta hospedagem ideal para relaxar e curtir a cidade com tranquilidade. Um espaço acolhedor, funcional e bem equipado para você se sentir em casa desde o início.`,fullDescription:`Suítes — Detalhes
